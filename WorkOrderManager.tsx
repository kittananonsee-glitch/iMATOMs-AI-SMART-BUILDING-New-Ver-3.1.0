    ...
    <div className="flex h-full overflow-hidden">
      <nav className="w-64 border-r border-red-500/20 bg-black/40 flex flex-col p-4 shrink-0">
        <div className="mb-10 p-4">
          <h1 className="font-display text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-red-400 to-orange-400 uppercase italic">iMATOMs PRO</h1>
        ...
        <div className="pt-4 border-t border-white/5 mt-auto">
          <button onClick={onBack} className="flex items-center gap-3 p-3 w-full text-white/60 hover:text-white hover:bg-red-500/10 rounded-xl transition-all">
            ...
            <span className="text-[10px] font-black uppercase italic tracking-widest">BACK TO MAIN</span>
          </button>
        </div>
      </nav>
